      ...
      <div className="mx-auto max-w-[1240px] px-17 max-lg:px-6">
        <div className="grid grid-cols-[0.8fr_1.2fr] items-center gap-19.5 max-[980px]:grid-cols-1 max-[980px]:gap-14">
          <div className="relative max-[980px]:mx-auto max-[980px]:max-w-90">
            ...
            {/* No "30 years" chip here. The heading beside it already opens with
                the same three words, and the opening paragraph used to say it a
                third time — the number was stated three times inside one section,
                which reads as insistence rather than emphasis. */}
            ...
            <div className="relative aspect-[1/1.42] overflow-hidden rounded-t-full rounded-b-panel bg-navy shadow-[0_40px_80px_-52px_rgb(13_31_51_/_0.55)]">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
          ...
          <div>
            ...
            <p className="mb-5.5 max-w-[38em] text-[16.5px] leading-loose text-tx-mid">
              {/* Opened "has worked in property search since 1994, in a family that
                  was doing it before that" — the heading directly above says both of
                  those things already. What survives is the part the heading does not
                  say. */}
              <ConfigValue field={founder.name} /> started in{" "}
              <ConfigValue field={company.founderStartYear} />. Since then the independent sector has
              grown, consolidated and largely been bought up. We are still here, and still
              independent.
            </p>
            ...
            <p className="mb-5.5 max-w-[38em] text-[16.5px] leading-loose text-tx-mid">
              ...
              the Association of Independent Personal Search Agents, so she helps set the standards
              independent agents work to — and hears early when an authority starts to slip.
            </p>
            ...
            <p className="max-w-[38em] text-[16.5px] leading-loose text-tx-mid">
              Most of our work comes from firms who have used us for years, and the people they
              refer. That is the part of the business we care most about keeping.
            </p>
