  ...
  return (
    <footer className="bg-[#FDFDFF] text-[#2D2D2D]">
      ...
      <div className="relative -mt-16 h-60 w-full" aria-hidden="true">
        <div className="pointer-events-none absolute left-1/2 -z-10 -translate-x-1/2 text-center text-[348px] font-bold leading-none before:bg-linear-to-b before:from-[#2D2D2D]/20 before:to-[#2D2D2D]/10 before:to-80% before:bg-clip-text before:text-transparent before:content-['Property'] after:absolute after:inset-0 after:bg-[#2D2D2D]/30 after:bg-clip-text after:text-transparent after:mix-blend-darken after:content-['Property'] after:[text-shadow:0_1px_0_#2D2D2D]"></div>
        {/* Glow */}
        <div
          className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-2/3"
          aria-hidden="true"
        >
          <div className="h-56 w-56 rounded-full border-[20px] border-[#4C96DE] blur-[80px]"></div>
        </div>
      </div>
    </footer>
  );
